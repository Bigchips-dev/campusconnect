/**
 * CampusConnect — Full Service Category System
 *
 * 18 categories with icons (Lucide names), colors, descriptions,
 * and exhaustive subcategories. Shared between server and client.
 */
...
const LEVELS = ['100L', '200L', '300L', '400L', '500L', 'Postgraduate', 'Staff'];
...
module.exports = { CATEGORIES, FACULTIES, LEVELS, GENDERS };
